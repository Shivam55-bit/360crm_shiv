  ...
  const integrations: IntegrationDoc[] = [
    {
      ...
      status: 'ACTIVE',
      config: {
        userId: 'TI_SHIV_SHAKTI_99',
        apiKey: 'ti_live_sec_778899aabbcc',
        webhookUrl: '/api/tradeindia/webhook',
        autoAssignLead: true,
        defaultRep: 'usr_admin_sales'
      },
    ...
    },
    {
      ...
      status: 'ACTIVE',
      config: {
        webhookEndpoint: '/api/website-leads',
        secretToken: 'whsec_360crm_webleads_2026',
        notifySalesEmail: true
      },
    ...
    },
    {
      ...
      config: {
        ...
        templates: ['quote_alert', 'order_dispatched', 'invoice_ready']
      },
